export default function AlertMessage(props) {
    return (
        <div className= {"flex items-center " + props.code + " text-white text-sm font-bold px-4 py-3"} role="alert">
            <svg className="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path
                    ...
                    5.352c-.246.945-.141 1.271.106 1.271.317 0 1.357-.392 2.379-1.207l.6.814C12.098 19.02 9.365 20 8.309 20z"/>
            </svg>
            <p>{props.message}</p>
        </div>
    )
